...
certbot certonly -m $1@gmail.com -n --agree-tos --manual-public-ip-logging-ok -d *.$2 --manual --preferred-challenges dns --manual-auth-hook "/root/code/certbot/au.sh python txy add" --manual-cleanup-hook "/root/code/certbot/au.sh python txy clean"
# 验证证书
