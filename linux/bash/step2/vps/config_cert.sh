...
cp /etc/letsencrypt/live/$2/cert.pem /root/code/docker/dockerfile_work/xray/cert
cp /etc/letsencrypt/live/$2/key.pem /root/code/docker/dockerfile_work/xray/cert
