...
cp /etc/letsencrypt/live/$2/fullchain.pem /root/code/docker/dockerfile_work/xray/cert
cp /etc/letsencrypt/live/$2/privkey.pem /root/code/docker/dockerfile_work/xray/cert
